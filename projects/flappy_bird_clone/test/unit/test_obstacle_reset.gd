...
# 	# I think this is probably bad design, it should already be set or the game is broken
# 	# _obstacle.settings = FlappyBirdSettings
	
# 	# Position obstacle somewhere reasonable
# 	_obstacle.position = Vector2(500, 300)
	
# 	# TODO: This is a hack to get the test to work, we should probably just use the real screen edge collider
